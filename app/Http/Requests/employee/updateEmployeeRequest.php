...
class updateEmployeeRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'cpf' => 'required|string|max:14|unique:employees,cpf,'.$this->employee->id,
            'rg' => 'required|string|max:30|unique:employees,rg,'.$this->employee->id,
            'sus_card' => 'required|string|max:50|unique:employees,sus_card,'.$this->employee->id,
            'isAlive' => 'required',
            'deathCause' => 'max:350',
