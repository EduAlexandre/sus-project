...
class CreateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'cpf'          => 'bail|required|string|max:14|unique:employees',
            'mother'       => 'bail|required|string|min:5|max:150',
            'rg'           => 'bail|required|string|max:30|unique:employees',
            'sus_card'     => 'bail|required|string|max:50|unique:employees',
            'isAlive'      => 'bail|required',
            'deathCause'   => 'bail|max:1000',
